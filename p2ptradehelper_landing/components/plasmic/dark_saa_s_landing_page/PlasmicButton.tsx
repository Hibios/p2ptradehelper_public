...
import sty from "./PlasmicButton.module.css"; // plasmic-import: BBnBngbU-SWcU/css
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_navLinkOrange]: hasVariant(
            variants,
            "color",
            "navLinkOrange"
          ),
    ...
    >
      {(hasVariant(variants, "iconOnly", "iconOnly") ? false : true)
        ? p.renderPlasmicSlot({
            ...
            className: classNames(sty.slotTargetChildren, {
              ...
              [sty.slotTargetChildrencolor_navLinkOrange]: hasVariant(
                variants,
                "color",
                "navLinkOrange"
              ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__vqFz)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__wq2W3)}
                role={"img"}
              />
            ),
