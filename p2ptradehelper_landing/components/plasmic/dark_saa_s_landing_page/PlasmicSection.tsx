...
import sty from "./PlasmicSection.module.css"; // plasmic-import: mkuY5Znd7ymWD/css

export type PlasmicSection__VariantMembers = {
  background: "dark" | "gray" | "shadow" | "office";
  size: "fullContentWidth" | "fullContentGallery" | "mobile";
};

export type PlasmicSection__VariantsArgs = {
  background?: SingleChoiceArg<"dark" | "gray" | "shadow" | "office">;
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootbackground_office]: hasVariant(
            variants,
            "background",
            "office"
          ),
          [sty.rootbackground_shadow]: hasVariant(
            variants,
            "background",
            "shadow"
          ),
    ...
    >
      <div
        ...
        className={classNames(projectcss.all, sty.freeBox, {
          ...
          [sty.freeBoxbackground_shadow]: hasVariant(
            variants,
            "background",
            "shadow"
          ),
